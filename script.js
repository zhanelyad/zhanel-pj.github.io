...
function changeContent(period) {
    ...
    if (period === "2012-2019") {
        ...
        document.getElementById("schoolImage").src = "school1.png"; 
        ...
        document.getElementById("schoolImage").src = "school2.png"; 
        ...
        document.getElementById("schoolImage").src = "sdu.png"; 
        document.getElementById("schoolName").innerText = "SDU University. Computer Scince major";
